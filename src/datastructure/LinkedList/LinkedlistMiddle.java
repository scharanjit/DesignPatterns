...
/**
 * Given a singly linked list, find middle of the linked list. For examplewithoutbridge,
 ...
 * to print second middle element. For examplewithoutbridge, if given linked list is
