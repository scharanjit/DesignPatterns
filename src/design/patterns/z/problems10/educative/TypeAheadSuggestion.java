...
//trie is basically a pre fix based search !!
// we can do same thing with HashTable but HashTable can not do prefix based search
//Also regular hashtable takes more space than a trie
