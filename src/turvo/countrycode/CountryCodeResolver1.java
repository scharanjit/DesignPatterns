...
public class CountryCodeResolver1 {

    public static void main(String[] args) {
        System.out.println( CountryCode.getByCode("IN").getName());
        System.out.println( CountryCode.getByCode("IN").getNumeric());
        System.out.println( CountryCode.getByCode("IN").getAlpha2());
        System.out.println( CountryCode.getByCode("IN").getAlpha3());
        System.out.println( CountryCode.getCountryCode("India"));
    }
 ...
 enum CountryCode
{
    ...
    public static CountryCode getCountryCode(String name)
    {
        try
        {
            return Enum.valueOf(CountryCode.class, name);
        }
